...
import io.quee.fragmentation.core.*
...
open class CoreActivity : AppCompatActivity(), ISupportActivity {
    ...
    /**
     * It is recommended to use [CoreFragment.start].
     */
    ...
    /**
     * It is recommended to use [CoreFragment.startForResult].
    ...
    /**
     * It is recommended to use [CoreFragment.startWithPop].
    ...
    /**
     * It is recommended to use [CoreFragment.startWithPopTo].
     *
     * @see .popTo
     * @see .start
     */
    ...
    /**
     * It is recommended to use [CoreFragment.replaceFragment].
     */
    fun replaceFragment(
        toFragment: ISupportFragment?,
        addToBackStack: Boolean
